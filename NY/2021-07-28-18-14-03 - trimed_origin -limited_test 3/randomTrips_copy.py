...
def get_options(args=None):
    optParser = sumolib.options.ArgumentParser(
        description="Generate trips between random locations")
    ...
    optParser.add_argument("-e", "--end", default=3600,
    ...
    optParser.add_argument("-s", "--seed", type=int,
    ...
    def generate_one(idx):
        ...
        try:
            ...
            if True:
                if random.random() < 1:
                    if random.random() < 0.66:
                        if random.random() < 0.5:
                            attrFrom = ' from="276074127"'
                            attrTo = ' to="274886548#1"'  # 274886545#0  or 5680831#13         274886548#0
                        else:
                            attrFrom = ' from="274886548#0"'
                            attrTo = ' to="274886548#1"'
                    else:
                ...
                # else:
                #     # flow 랑 상관없는 거
                #     attrFrom = ' from="-274886545#0"'
                #     attrTo = ' to="275390415#5"'
            via = ""
